        ...
        <el-row class="container">
            <el-col :span="8" class="op" :style="{ height: height }">
                <el-row class="login">
                    ...
                    <el-col>
                        <el-form class="loginForm" ref="loginForm" :model="loginInfo" label-position="top"
                                 label-width="80px" :rules="loginRules">
                            ...
                            <el-form-item>
                                <el-button class="submit" type="primary" @click="login" :loading="onLogin">登录
                                </el-button>
                            </el-form-item>
                            <el-form-item>
            ...
            <el-col :span="16" class="pic" :style="{ height: height, backgroundImage:`url(${img})` }">
            </el-col>
        </el-row>
